function [ w_plus, w_minus ] = train_rnn_ff(inputdata, targetdata, eta, w_plus, w_minus, r_o)
...
%     w_plus = w_plus - nu .* sum(bsxfun(@times,dq_dw_plus,error_weights),3);      % Calculating more derivatives than necessary.
%     w_minus = w_minus - nu .* sum(bsxfun(@times,dq_dw_minus,error_weights),3);   % This should be optimized out at some point.
